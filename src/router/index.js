...
export const constantRoutes = [
...

    {
        ...
        children: [
            ...
            },
            {
                path: "classify-list",
                name: "classify-list",
                component: () => import("@/views/classify-list/index"),
            ...
            },
            {
                ...
                meta: { title: "发表文章", icon: "guide" }
            },
            {
                path: "edit",
                name: "edit",
                component: () => import("@/views/edit/edit"),
                meta: { title: "编辑文章", icon: "guide" },
                hidden: true
            }
        ]
    },

    {
        path: "/information",
        component: Layout,
        redirect: "/information/leave",
        name: "information",
        meta: { title: "评论与留言", icon: "form" },
        children: [
            {
                path: "leave",
                name: "leave",
                component: () => import("@/views/leave/index"),
                meta: { title: "留言信息", icon: "form" }
            },
            {
                path: "comment",
                name: "comment",
                component: () => import("@/views/comment/index"),
                meta: { title: "文章评论", icon: "form" }
            }
        ]
    },
